...
<div class="row">
    ...
    <h2 class="page-header">This area can be used to assign a mechanic to a booking.</h2>
    <h3 style="color:green;text-align:left;">In order to assign a mechanic to a booking, please select a date in the below dropdown menu to view bookings for that date.</h3>

    <br>

</div>

<form action="list_bookings_for_assignment_of_mechanic.php" method="get">

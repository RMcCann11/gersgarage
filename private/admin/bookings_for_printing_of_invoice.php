...
<div class="row">
    ...
    <h2 class="page-header">This area can be used to generate an invoice for a booking.</h2>
    <h3 style="color:green;text-align:left;">In order to generate an invoice for a booking, please select a date in the below dropdown menu to view bookings for that date.</h3>

    <br>

</div>

<form action="list_bookings_for_printing_of_invoice.php" method="get">
